    ...
    public HinzufuegenGUI()
    {
         ...
         add.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae) { 
              ...
              String variableEBVorname = EBVorname.getText();
              String variableEBBeruf = EBBeruf.getText();
              ...
              //Erstellen eines standartmäßigen INSERT INTO Strigs für Schüler und Erziehungsberechtigte
              String INSERTSchueler = "SNachname,SVorname,SGebDatum,SStrasse,SHausNr,SPlz,SOrt,SSchultyp,SKlasse,SWahlpflichtkurs,SBeiDatum,SZimmerOrt,SZimmerNr,SFoerderbedarf,SAnmerkungen";
              String INSERTEltern = "EBNachname,EBVorname,EBBeruf,EBStrasse,EBHausNr,EBPlz,EBOrt,EBEmail,EBTelefon,EBHandy";
              
              
              //Einfügen der Daten in die Datenbank als String
              String insertStringKind = "INSERT INTO schuelerdaten ("+INSERTSchueler+") VALUES ("+datenKind+");";
              System.out.println(insertStringKind); 
              String insertStringEltern = "INSERT INTO elterndaten ("+INSERTEltern+") VALUES ("+datenEltern+");";
              System.out.println(insertStringEltern);
              createConnection();
              try {
                 stmt.executeQuery(insertStringKind);
                 stmt.executeQuery(insertStringEltern);
                } catch (Exception e) {
